...
struct FaceDetection {
  ...
  std::array<FaceLandmark, 5> landmarks;  // left_eye, right_eye, nose, mouth_l, mouth_r
};
...
/// Landmarks are encoded into a companion vector accessible via GetLastLandmarks().
///
